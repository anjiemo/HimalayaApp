...
public class ImageBlur {
    ...
    public static void makeBlur(Context context, Drawable drawable, ImageView imageView) {
        Bitmap blurred = transform(context, drawable);
        imageView.setImageBitmap(blurred); //radius decide blur amount
    }
    ...
    public static Bitmap transform(Context context, Drawable drawable) {
        Bitmap bitmap = ImageTools.drawableToBitmap(drawable);
        return blurRenderScript(bitmap, 10, context);
    }

    public static Bitmap transform(Context context, Bitmap bitmap) {
        return blurRenderScript(bitmap, 10, context);
    }
